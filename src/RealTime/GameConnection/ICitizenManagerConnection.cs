...
namespace RealTime.GameConnection
{
    ...
    internal interface ICitizenManagerConnection<TCitizen> where TCitizen : struct
    {
        /// <summary>Releases the specified citizen.</summary>
        /// <param name="citizenId">The ID of the citizen to release.</param>
        internal void ReleaseCitizen(uint citizenId);
        ...
        internal ushort GetTargetBuilding(ushort instanceId);
        ...
        internal ushort GetTargetNode(ushort instanceId);
        ...
        internal bool InstanceHasFlags(ushort instanceId, CitizenInstance.Flags flags, bool all = false);
        ...
        internal CitizenInstance.Flags GetInstanceFlags(ushort instanceId, CitizenInstance.Flags mask);
        ...
        internal byte GetInstanceWaitCounter(ushort instanceId);
        ...
        internal bool IsAreaEvacuating(ushort instanceId);
        ...
        internal bool ModifyUnitGoods(uint unitId, ushort amount);
        ...
        internal uint GetInstancesCount();
        ...
        internal Citizen.Location GetCitizenLocation(uint citizenId);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">Thrown when the argument is 0.</exception>
        internal Citizen.Wealth GetCitizenWealth(uint citizenId);
        ...
        internal bool TryGetFamily(uint citizenId, uint[] targetBuffer);
        ...
        internal TCitizen[] GetCitizensArray();
        ...
        internal void StopMoving(ushort instanceId, bool resetTarget);
        ...
        internal ref TCitizen GetCitizen(ushort instanceId);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">Thrown when <paramref name="instanceId"/> is 0.</exception>
        internal Vector3 GetCitizenPosition(ushort instanceId);
    }
}
