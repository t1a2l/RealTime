...
namespace RealTime.GameConnection
{
    ...
    internal interface ICitizenConnection<T> where T : struct
    {
        ...
        internal ushort GetHomeBuilding(ref T citizen);
        ...
        internal ushort GetWorkOrSchoolBuilding(ref T citizen);
        ...
        internal ushort GetVisitBuilding(ref T citizen);
        ...
        internal ushort GetHotelBuilding(ref T citizen);
        ...
        internal ushort GetInstance(ref T citizen);
        ...
        internal ushort GetVehicle(ref T citizen);
        ...
        /// </returns>
        internal bool IsCollapsed(ref T citizen);
        ...
        /// </returns>
        internal bool IsDead(ref T citizen);
        ...
        /// </returns>
        internal bool IsSick(ref T citizen);
        ...
        internal void SetSick(ref T citizen, bool isSick);
        ...
        /// </returns>
        internal bool IsArrested(ref T citizen);
        ...
        internal void SetArrested(ref T citizen, bool isArrested);
        ...
        internal void SetLocation(ref T citizen, Citizen.Location location);
        ...
        internal Citizen.AgeGroup GetAge(ref T citizen);
        ...
        internal Citizen.Wealth GetWealthLevel(ref T citizen);
        ...
        internal Citizen.Education GetEducationLevel(ref T citizen);
        ...
        internal Citizen.Gender GetGender(uint citizenId);
        ...
        internal Citizen.Happiness GetHappinessLevel(ref T citizen);
        ...
        internal Citizen.Wellbeing GetWellbeingLevel(ref T citizen);
        ...
        internal uint GetHealth(ref T citizen);
        ...
        /// </returns>
        internal bool HasFlags(ref T citizen, Citizen.Flags flags);
        ...
        internal void SetHome(ref T citizen, uint citizenId, ushort buildingId);
        ...
        internal void SetWorkplace(ref T citizen, uint citizenId, ushort buildingId);
        ...
        internal void SetVisitPlace(ref T citizen, uint citizenId, ushort buildingId);
        ...
        internal Citizen.Flags AddFlags(ref T citizen, Citizen.Flags flags);
        ...
        internal Citizen.Flags RemoveFlags(ref T citizen, Citizen.Flags flags);
        ...
        internal uint GetContainingUnit(ref T citizen, uint citizenId, uint unitId, CitizenUnit.Flags flag);
        ...
        internal bool IsEmpty(ref T citizen);
        ...
        internal void SetHotel(ref T citizen, uint citizenId, ushort buildingId, uint unitID);
        ...
        /// <param name="citizenId">The citizen ID.</param>
        internal void ResetHotel(ref T citizen, uint citizenId);
